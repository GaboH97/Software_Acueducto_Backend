...
/*INSERT FACTURAS*/
 ...
 insert into FACTURAS (fecha_emision, fecha_maximo_pago, fecha_pago, estado_factura, predio_numero_matricula, periodo_facturado) values ('2019-06-20','2018-07-05',NULL,'VE','080-7356', '2019-06-02');
...
/*INSERT DETALLES_FACTURA*/
 ...
 insert into DETALLES_FACTURA (factura_id, tarifa_id, cantidad, valor, valor_unitario) values (7,2,1,27604,27604);
...
insert into usuarios (cedula, nombre, apellido, fecha_nacimiento, usuario, contrasena, genero, direccion_residencia, lugar_id, activo, rol_id) values ('2069701934', 'Gabriel', 'Huertas','2019-03-02', 'admin','$2a$10$L.4tNBVQa/nABm.F6ZTNLewLB9IblG8oumBTRPXVraPR6KFV8Hiwi','F','Carrera 7 # 21 - 97',2, 1, 1);
insert into usuarios (cedula, nombre, apellido, fecha_nacimiento, usuario, contrasena, genero, direccion_residencia, lugar_id, activo, rol_id) values ('2069701935', 'Pedro', 'Aguirre','2019-03-02', 'fontanero','$2a$10$YFdPmP7PyoM8Naxs0NPClupAG4rhspHbRo6y.E6OnqkNyQgpvNGtm','F','Carrera 10 # 2 - 10',2, 1, 2);
insert into usuarios (cedula, nombre, apellido, fecha_nacimiento, usuario, contrasena, genero, direccion_residencia, lugar_id, activo, rol_id) values ('2069701936', 'Ángel', 'Gutierrez','2019-03-02', 'tesorero','$2a$10$YFdPmP7PyoM8Naxs0NPClupAG4rhspHbRo6y.E6OnqkNyQgpvNGtm','F','Calle 24 # 18 - 10',2, 1, 3);
